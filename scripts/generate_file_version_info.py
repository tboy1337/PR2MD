...
FILE_DESCRIPTION = "PR2MD - Pull Request to Markdown"
LEGAL_COPYRIGHT = (
  ...
  kids=[
    StringFileInfo([
      StringTable(
        ...
        StringStruct(u'InternalName', u'PR2MD'),
        StringStruct(u'LegalCopyright', u'{LEGAL_COPYRIGHT}'),
        StringStruct(u'OriginalFilename', u'PR2MD.exe'),
        StringStruct(u'ProductName', u'PR2MD'),
